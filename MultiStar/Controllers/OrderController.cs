...
namespace appDash.Controllers
{
    public class OrderController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,CreationDate,IsActive,CustomerId")] Order order)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,CreationDate,IsActive,CustomerId")] Order order)
        {
            if (id != order.Id)
            {
                return NotFound();
